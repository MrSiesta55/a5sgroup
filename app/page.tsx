          ...
          {(() => {
            ...
            return (
              <div className="flex flex-wrap justify-center gap-4 sm:gap-5">
                {techs.map((tech, i) => (
                  <div key={i} className="w-28 h-28 sm:w-32 sm:h-32 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 flex flex-col items-center justify-center gap-2 sm:gap-3 hover:bg-white/10 hover:border-white/30 transition-[background-color,border-color] duration-300 cursor-default">
